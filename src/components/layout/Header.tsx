...
import SearchBar from "../ui/CardBusqueda";
import CardButtonHeader from "../ui/CardButtonHeader";
    ...
    <header className="bg-fondo w-full flex items-center justify-center h-[5%]">
      <div className="w-full 2xl:max-w-[1920px] bg-fondo flex justify-between">
        <div className="flex flex-row py-[8px] pl-2  items-center">
          <span className="text-white pl-5">
            <svg
              role="img"
              viewBox="0 0 24 24"
              className="e-91000-logo e-91000-baseline cursor-pointer"
              aria-label="Spotify"
              aria-hidden="false"
              height="32"
        ...
        <div className="  flex flex-row items-center gap-2">
          <button className="text-house p-[12px] rounded-full  border border-black bg-fondoHouse hover:bg-black transition-all duration-300 delay-80 ">
            <svg
              ...
              role="img"
              aria-hidden="true"
              className="e-91000-icon e-91000-baseline cursor-pointer"
              viewBox="0 0 24 24"
              height="24"
            >
              <title>Inicio</title>
        ...
        <div className="flex flex-row gap-2 items-center py-1">
          <CardButtonHeader title="Premium" />
          <CardButtonHeader title="Ayuda" />
          <CardButtonHeader title="Descargar" />

          <div className=" m-4 flex h-6 items-center w-[0.5] bg-white"></div>

          <button
            className="inline-flex items-center gap-2 whitespace-nowrap
             text-sm font-semibold text-gray-300
             hover:text-white transition-colors duration-200 pl-2 pr-4 py-1 cursor-pointer"
          >
            <svg
              viewBox="0 0 16 16"
