...
export default function Footer() {
  return (
    <div className="bg-black w-full px-2 py-2 ">
      <div className=" w-full py-[8px] flex items-center px-4 bg-gradient-to-r from-footer via-purple-500 to-footerSky">
        <div className="flex w-full justify-between max-w-[1920px] ">
